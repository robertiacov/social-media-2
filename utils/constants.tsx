...
export const footerList1 = ['About', 'News', 'Store', 'Contact', 'Carrers', 'Creator Directory']
export const footerList2 = [ 'VidVers','Advertise','Developers','Transparency','VidVers Rewards' ]
